...
Begin VB.Form main 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         Tab(0).Control(0)=   "lblProductName"
         Tab(0).Control(1)=   "lblVersion"
         Tab(0).Control(2)=   "lblCSDVersion"
         Tab(0).Control(3)=   "lblProductID"
         Tab(0).Control(4)=   "lblROwner"
         Tab(0).Control(5)=   "lblROrganization"
         Tab(0).ControlCount=   6
         TabCaption(1)   =   "Processor"
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "lblSysID"
         Tab(1).Control(1)=   "lblVendorID"
         Tab(1).Control(2)=   "lblProcessorName"
         Tab(1).Control(3)=   "lblIdentifier"
         Tab(1).Control(4)=   "lblMHz"
